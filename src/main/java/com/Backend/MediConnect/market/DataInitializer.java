package com.Backend.MediConnect.market;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void cargarEspecialidades() {
        if (especialidadRepo.count() > 0) return;
    ...
    private void cargarAdminTotal() {
        if (usuarioRepo.existsByDni("00000001")) return;
    ...
    private void cargarAdminLocal() {
        if (usuarioRepo.existsByDni("00000002")) return;
    ...
    private void cargarMedicos() {
        if (usuarioRepo.existsByDni("00000003")) return;
    ...
    private void cargarPacientes() {
        if (usuarioRepo.existsByDni("00000004")) return;
